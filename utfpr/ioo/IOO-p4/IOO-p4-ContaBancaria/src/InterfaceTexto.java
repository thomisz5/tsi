...
//basicamente refatorar os if's que tinham antes pela nova superclasse
public class InterfaceTexto {
    ...
    private void leiaVerifiqueOpcoesMenuPrincipal() {
        ...
        switch (opcao) {
            ...
            case "2":
                ...
                break;
            case "3":
                mostrarContas();//add o novo método no menu
                break;
            case "4":
                processarContas();
                break;
    ...
    private void mostrarContas() {
        imprimirCabecalhoDaListagemDeContas("Contas");
        for (Conta c : banco.getContas()) {
            sf("| %-6d | %-4s | %-5s | %-21s |\n", c.getNumero(),c.getTipo(), c.getSaldo(),
	...
	/*private void mostrarContasCorrente() {//inves de listar as duas, vamo listar Contas
