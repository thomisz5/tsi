...
public class Agenda {
    ...
    public Contato removerSecreto(int indice) {
        Contato removerContatoSecreto = contatos.remove(indice);
        return removerContatoSecreto;
    }

    public Contato addSecreto(Contato contatoSecreto) {
        contatos.add(contatoSecreto);
        return contatoSecreto;
    }
