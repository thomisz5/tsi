...
public class InterfaceTexto {
    ...
    private void marcarContatoComoSecreto() {
        ...
        agenda.getContatoPeloId(Integer.parseInt(idS));
        agenda.addSecreto(agenda.getContatoPeloId(Integer.parseInt(idS)));

        Contato contatoSecreto = new Contato();//errado, nao é pra criar um novo e sim para retornar, mas nao estou conseguidno
        sln("O contato '" + contatoSecreto.getNomeCompleto() + "' foi escondido com sucesso!");
    }
    ...
    private void desmarcarContatoSecreto() {
        ...
        Contato secretoDesmarcado = agenda.removerSecreto(index);

        sln("O contato '" + secretoDesmarcado.getNomeCompleto() + "' foi retornado com sucesso!");
